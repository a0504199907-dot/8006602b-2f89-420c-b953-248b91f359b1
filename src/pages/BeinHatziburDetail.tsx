    ...
    <ArticleDetailLayout
      ...
      <article data-ev-id="ev_a4f96dcc48">
          ...
          <span data-ev-id="ev_f71c7c9441" className="inline-block bg-blue-100 text-blue-800 px-3 py-1 rounded-full text-sm font-medium mb-4">
            ...
            <h1 data-ev-id="ev_c930f04cc4" className="text-3xl md:text-4xl font-bold text-foreground font-serif mb-4 leading-tight">
              {item.title}
            </h1>
            {item.caption &&
          <p data-ev-id="ev_807968d87a" className="text-xl text-muted-foreground mb-6">{item.caption}</p>
          }
